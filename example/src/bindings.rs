...
pub mod api {
    ...
    pub extern "C" fn __async_hello_world() -> i64 {
        panic_abort(move || {
            let tmp0 = async_hello_world();
            #[allow(unused_assignments)] let mut tmp1 = Default::default();
            let tmp1_0 = async move { tmp0.await.map_err(|err| err.to_string()) };
    ...
    pub extern "C" fn __get_image() -> i64 {
        panic_abort(move || {
            let tmp0 = get_image();
            #[allow(unused_assignments)] let mut tmp1 = Default::default();
            let tmp0_0 = assert_send_static(tmp0);
    ...
    pub extern "C" fn __create(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = create(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
    ...
    pub extern "C" fn __get_u16_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_u16_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_u32_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_u32_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_u64_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_u64_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_i16_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_i16_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_i32_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_i32_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_i64_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_i64_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_f32_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_f32_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __get_f64_counting(tmp1: u64) -> i64 {
        panic_abort(move || {
            let tmp0 = tmp1 as _;
            let tmp2 = get_f64_counting(tmp0);
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            let tmp2_0 = assert_send_static(tmp2);
            tmp3 = Box::into_raw(Box::new(tmp2_0)) as _;
            tmp3
    ...
    pub extern "C" fn __create_list() -> i64 {
        panic_abort(move || {
            let tmp0 = create_list();
            #[allow(unused_assignments)] let mut tmp2 = Default::default();
            let tmp1 = FfiListCustomType::new(tmp0);
            let tmp1_0 = assert_send_static(tmp1);
    ...
    pub extern "C" fn __sum_list(tmp1: i64) -> u32 {
        panic_abort(move || {
            let tmp2 = unsafe { Box::from_raw(tmp1 as *mut FfiListCustomType) };
            let tmp0 = tmp2.data;
            let tmp3 = sum_list(tmp0);
            #[allow(unused_assignments)] let mut tmp4 = Default::default();
            tmp4 = tmp3 as _;
            tmp4
        })
    }
    ...
    pub extern "C" fn __DataTest_get_copy(tmp1: i64) -> __DataTest_get_copyReturn {
        panic_abort(move || {
            let tmp0 = unsafe { &mut *(tmp1 as *mut DataTest) };
            let tmp2 = tmp0.get_copy();
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            #[allow(unused_assignments)] let mut tmp4 = Default::default();
            #[allow(unused_assignments)] let mut tmp5 = Default::default();
            let tmp2_0 = ManuallyDrop::new(tmp2);
    ...
    pub extern "C" fn __CustomType_get_n(tmp1: i64) -> i32 {
        panic_abort(move || {
            let tmp0 = unsafe { &mut *(tmp1 as *mut CustomType) };
            let tmp2 = tmp0.get_n();
            #[allow(unused_assignments)] let mut tmp3 = Default::default();
            tmp3 = tmp2 as _;
            tmp3
    ...
    pub extern "C" fn __async_hello_world_future_poll(tmp1: i64, tmp3: i64, tmp5: i64) -> __async_hello_world_future_pollReturn {
        panic_abort(move || {
            let tmp0 = unsafe { &mut *(tmp1 as *mut FfiFuture<Result<u8>>) };
            let tmp2 = tmp3 as _;
            let tmp4 = tmp5 as _;
            let tmp6 = tmp0.poll(tmp2, tmp4);
            #[allow(unused_assignments)] let mut tmp7 = Default::default();
            #[allow(unused_assignments)] let mut tmp9 = Default::default();
            #[allow(unused_assignments)] let mut tmp12 = Default::default();
            #[allow(unused_assignments)] let mut tmp13 = Default::default();
            #[allow(unused_assignments)] let mut tmp14 = Default::default();
            #[allow(unused_assignments)] let mut tmp15 = Default::default();
            if let Some(tmp8) = tmp6 {
                tmp7 = 1;
                match tmp8 {
                    Ok(tmp10) => {
                        tmp9 = 1;
